...
The current version is <ins>**v1.1.0**</ins> and is compatible with Rift of the NecroDancer Patch 1.10.0 released on 30 October 2025. Downloads for the latest version can be found [here](https://github.com/96-LB/CustomPortRifts/releases/latest). The changelog can be found [here](Changelog.md).
