...
The current version is <ins>**v1.0.1**</ins> and is compatible with Rift of the NecroDancer Patch 1.7.0 released on 13 August 2025. Downloads for the latest version can be found [here](https://github.com/96-LB/CustomPortRifts/releases/latest). The changelog can be found [here](Changelog.md).
